/* Get Digital Input for i8k modules.
...
int main(int argc, char **argv)
{
	...
	if (argc != 3) {
		...
		printf("function : getdi\n");
		printf("Get digital input value from a module\n");
		printf("Usage: getdi slot type\n");
		printf("Example :getdi 1 16\n");
		printf("Get the 16bit dec digital input value from slot 1\n");
		return FAILURE;
	}

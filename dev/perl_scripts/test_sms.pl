...
eval {
	$self = $DBH->run( sub {
		...
		foreach my $_i ( @$arr )
		{
			print "[$_i->{Category}] $_i->{Name} => $_i->{Setting} \n";
...
my $params = {
	...
	'recip' => [
		...
		'4433984370@ATT_Wireless_SMTP',
		'7249808155@ATT_Wireless_SMTP',
		'8145250314@ATT_Wireless_SMTP',
		'8145257250@ATT_Wireless_SMTP',
		'8145251031@ATT_Wireless_SMTP',
		'8146598873@ATT_Wireless_SMTP',
		'8145252684@ATT_Wireless_SMTP',
		'8145250377@ATT_Wireless_SMTP',
		'8145257113@ATT_Wireless_SMTP'
	],

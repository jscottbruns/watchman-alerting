...
Garmin.DevicePlugin.prototype = {
	...
	getSupportsFitnessWrite: function() {
		try {
		    if( typeof this.plugin.StartWriteFitnessData == "function" ) {
		        return true;
		    }
		    else if( this.plugin.StartWriteFitnessData ) {
		        return true;
		    }
		    else {
		        return false;
	...
	getSupportsFitnessDirectoryRead: function() {
		try {
		    if( typeof this.plugin.StartReadFitnessDirectory == "function" ) {
		        return true;
		    }
		    else if( this.plugin.StartReadFitnessDirectory ) {
		        return true;
		    }
		    else {
		        return false;
	...
	getSupportsFitnessReadCompressed: function() {
		try {
		    if( typeof this.plugin.TcdXmlz == "string" ) {
		        return true;
		    }
		    else if( this.plugin.TcdXmlz ) {
		        return true;
		    }
		    else {
		        return false;
	...
	startReadFitnessData: function(deviceNumber, dataTypeName) {
		if( !this._checkPluginVersionSupport([2,1,0,3]) ) {
	...
	startReadFitnessDirectory: function(deviceNumber, dataTypeName) {
		if( !this._checkPluginVersionSupport([2,2,0,2]) ) {
	...
	startWriteFitnessData: function(tcdXml, deviceNumber, filename, dataTypeName) {	
		if( !this._checkPluginVersionSupport([2,2,0,1]) ) {
	...
	/** Used to check if the user's installed plugin version meets the passed in required version for feature support purposes.
	 *  
	 ...
	 * @private
	 */
	_checkPluginVersionSupport: function(reqVersionArray) {

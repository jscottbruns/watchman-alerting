...
Garmin.DeviceControl.prototype = {
    ...
    /** Checks plugin for updates.  These updates are not required, though an exception
     * is thrown, so use this function with caution.
     */
	 ...
	 * 
	 * @param {String} fileType Possible values for fileType are located in Garmin.DeviceControl.FILE_TYPES--detail 
...
//		if( !this._checkDeviceDataTypeSupport(fileType) ) {
//			throw new Error(Garmin.DeviceControl.MESSAGES.unsupportedDataType);
//		}
	 ...
	 * in this.gpsData as an XML DOM and this.gpsDataString as an XML string once the read successfully finishes. 
...
//		}
	...
	/** Writes binary data to the currently selected device. <br/>
	 * <br/>
	 * Minimum plugin version 2.0.0.4
     *
     * @param xmlDownloadDescription {String} xml string to be written to the device.
     * @param fileName {String} the filename to write the data to.
     */	
	...
	/** Writes the given TCX Course XML string to the device selected in this.deviceNumber. <br/>
	 * <br/>
	 * Minimum plugin version 2.2.0.1
	 * 
	...
	/** Writes the given TCX Workouts XML string to the device selected in this.deviceNumber. <br/>
	 * <br/>
	 * Minimum plugin version 2.2.0.1
	 * 
	...
	/** Writes the given TCX User Profile XML string to the device selected in this.deviceNumber. <br/>
	 * <br/>
	 * Minimum plugin version 2.2.0.1
	 * 
...
//	/** This function will work properly in the next version, when datatype values
//	 * will be changed.  
//	 * 
//	 * Checks if the device lists the given datatype as a supported type.
//	 * Plugin version affects the results of this function. 
//	 */
//	_checkDeviceDataTypeSupport: function( datatype ) {
//		
//		// The selected device
...
//			
//			if( dataTypes[i].getDisplayName() == datatype )
//				return true;
//		}
//		
//		return false;
...
Garmin.DeviceControl.FILE_TYPES = {
	...
	// The following types are internal types
